...
public class RemoveResourceServlet extends HttpServlet {
	...
	private static String removeResourceExample(String userName) {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		gateway.sendMessage(removeResourceExample(user), "root@localhost/Smack", "update", user.concat("@localhost/Smack"));
